...
class FavouriteRecyclerAdapter(val context: Context, val bookList:List<BookEntity>):RecyclerView.Adapter<FavouriteRecyclerAdapter.FavouriteViewHolder>() {
    ...
    class FavouriteViewHolder(view: View):RecyclerView.ViewHolder(view){
        val txtBookName:TextView=view.findViewById(R.id.facbookname)
        val txtBookAuthor:TextView=view.findViewById(R.id.facbookauthor)
        val txtBookPrice:TextView=view.findViewById(R.id.facbookprice)
        val txtBookRating:TextView=view.findViewById(R.id.facbookrating)
        val imgbook:ImageView=view.findViewById(R.id.favimage)
    ...
    override fun onBindViewHolder(holder: FavouriteViewHolder, position: Int) {
        ...
        holder.llcontent.setOnClickListener {
            ...
            val book_id=book.book_id.toString()
